    ...
    private void MigrateConfig()
    {
            ...
            <runtime>
                <assemblyBinding xmlns="urn:schemas-microsoft-com:asm.v1">
                 ...
                 <dependentAssembly>
            	    ...
            	    <bindingRedirect oldVersion="0.0.0.0-10.0.0.9" newVersion="10.0.0.10"/>
            	  </dependentAssembly>
                  <dependentAssembly>
        ...
        if (assemblyBindingNode != null)
        {
            ...
            if (asyncInterfaces != null)
            {
                ...
                var replaceNode = XElement.Parse("""<bindingRedirect oldVersion="0.0.0.0-10.0.0.10" newVersion="10.0.0.10"/>""");
            ...
            if (threadingTask != null)
            {
                ...
                var replaceNode = XElement.Parse("""<bindingRedirect oldVersion="0.0.0.0-4.2.4.0" newVersion="4.2.4.0"/>""");
